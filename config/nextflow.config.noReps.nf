...
report {
  enabled = false
  file = "${params.outdir}/nxfReports/${params.name}.tests.report.html"
}

timeline {
  enabled = false
  file = "${params.outdir}/nxfReports/${params.name}.tests.timeline.html"
}

trace {
  enabled = false
  file = "${params.outdir}/nxfReports/${params.name}.tests.trace.txt"
}
